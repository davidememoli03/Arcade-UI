import{n as e}from"./chunk-DnJy8xQt.js";var t,n,r,i,a,o,s;e((()=>{t={title:`Effects/CRT`,parameters:{docs:{description:{component:`@type { import('@storybook/html').Meta }`}}}},n={name:`.arc-crt-screen`,render:()=>`
  ...
  `},o={name:`Token personalizzati`,render:()=>`
  ...
  \`
}`,...o.parameters?.docs?.source}}},s=[`Screen`,`Boot`,`ScreenVariants`,`BootWithScreen`,`Tokens`]}))();export{r as Boot,a as BootWithScreen,n as Screen,i as ScreenVariants,o as Tokens,s as __namedExportsOrder,t as default};