import{n as e}from"./chunk-DnJy8xQt.js";function t({color:e,tabs:t}){let n=`tabs-${Math.random().toString(36).slice(2,7)}`;return`
  <div class="arc-tabs arc-tabs-${e}">
    ${t.map((e,t)=>`<input class="arc-tab-radio" type="radio" name="${n}" id="${n}-${t+1}"${t===0?` checked`:``}>`).join(`
  `)}
    <div class="arc-tab-list" role="tablist">
    ${t.map((e,t)=>`<label class="arc-tab" for="${n}-${t+1}">${e.label}</label>`).join(`
    `)}
    </div>
    ${t.map(e=>`
  ...
  </div>`}function n({color:e,tabs:t}){return`
  <div class="arc-tabs arc-tabs-${e}" data-arc-tabs>
    <div class="arc-tab-list" role="tablist">
    ${t.map(e=>`<button class="arc-tab" role="tab">${e.label}</button>`).join(`
    `)}
    </div>
    ${t.map(e=>`
  ...
  <\/script>`}var r,i,a,o,s,c,l,u,d;e((()=>{r={title:`Components/Tabs`,decorators:[e=>`<div style="padding:2rem;max-width:720px;">${e()}</div>`],argTypes:{color:{control:{type:`select`},options:[`cyan`,`magenta`,`yellow`,`green`,`red`,`purple`]},mode:{control:{type:`radio`},options:[`css-only`,`js-driven`],description:`CSS-only usa radio + :has(); js-driven usa data-arc-tabs + arcTabs()`}},args:{color:`cyan`,mode:`css-only`},parameters:{docs:{description:{component:`@type { import('@storybook/html').Meta }`}}}},i=[{label:`PLAYER`,content:`
      ...
      </div>`}],a={name:`CSS-only (radio + :has)`,args:{color:`cyan`},render:({color:e})=>t({color:e,tabs:i})},o={name:`CSS-only — Magenta`,args:{color:`magenta`},render:({color:e})=>t({color:e,tabs:i})},s={name:`JS-driven (data-arc-tabs)`,args:{color:`cyan`},render:({color:e})=>n({color:e,tabs:i})},c={render:()=>`
  ...
  `},l={name:`Multi-panel — Mission Control`,parameters:{layout:`fullscreen`,backgrounds:{default:`arcade-dark`}},render:()=>`
    <div style="
  ...
  `},u={name:`Tabs inside Panel`,render:()=>`
  ...
  \`
}`,...u.parameters?.docs?.source}}},d=[`CSSOnly`,`Magenta`,`JSDriven`,`AllColors`,`MultiPanelDemo`,`InPanel`]}))();export{c as AllColors,a as CSSOnly,u as InPanel,s as JSDriven,o as Magenta,l as MultiPanelDemo,d as __namedExportsOrder,r as default};