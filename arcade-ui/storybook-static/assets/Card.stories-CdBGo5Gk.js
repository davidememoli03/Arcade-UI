import{n as e}from"./chunk-DnJy8xQt.js";function t({color:e,variant:t,title:n,subtitle:r,avatar:i}){return`
    <div class="arc-card arc-card-${e}${t===`none`?``:` arc-card--${t}`}">
      <div class="arc-card-header">
        <div class="arc-card-avatar">${i}</div>
        <p class="arc-card-title">${n}</p>
        <p class="arc-card-subtitle">${r}</p>
      </div>
  ...
  `}var n,r,i,a,o,s,c,l,u,d,f;e((()=>{n={title:`Components/Card`,decorators:[e=>`<div style="padding:3rem;background:var(--arc-color-bg);min-height:100vh;">${e()}</div>`],argTypes:{color:{control:{type:`select`},options:[`cyan`,`red`,`yellow`,`green`,`purple`]},variant:{control:{type:`select`},options:[`none`,`glow`,`selected`,`locked`]},title:{control:`text`},subtitle:{control:`text`},avatar:{control:`text`}},args:{color:`cyan`,variant:`none`,title:`RYU`,subtitle:`Street Fighter`,avatar:`🥷`},parameters:{docs:{description:{component:`@type { import('@storybook/html').Meta }`}}}},r={render:t},i={args:{color:`cyan`,variant:`glow`,title:`SONIC`,subtitle:`SEGA Genesis`,avatar:`🦔`},render:t},a={args:{color:`yellow`,variant:`selected`,title:`LINK`,subtitle:`Hyrule`,avatar:`🗡️`},render:t},o={args:{color:`red`,variant:`locked`,title:`???`,subtitle:`LOCKED`,avatar:`❓`},render:t},s={render:()=>`
  ...
  `},l={name:`Character Select — Demo Grid`,parameters:{layout:`fullscreen`,backgrounds:{default:`arcade-dark`}},render:()=>`
    <div style="
  ...
  \`
}`,...d.parameters?.docs?.source}}},f=[`Default`,`Glow`,`Selected`,`Locked`,`AllColors`,`AllVariants`,`CharacterSelectScreen`,`NoFooter`,`WithBadge`]}))();export{s as AllColors,c as AllVariants,l as CharacterSelectScreen,r as Default,i as Glow,o as Locked,u as NoFooter,a as Selected,d as WithBadge,f as __namedExportsOrder,n as default};